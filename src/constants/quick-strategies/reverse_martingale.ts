...
export const REVERSE_MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [`${localize('Exploring the')} Reverse Martingale ${localize('strategy in ApexBot')}`],
        expanded: true,
    ...
    },
    {
        type: 'text',
        content: [
            `${localize('These are the trade parameters used in ApexBot with')} Reverse Martingale ${localize('strategy.')}`,
        ],
    },
    {
        type: 'text',
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. If the first trade is a successful trade, ApexBot will automatically double your stake for the next trade to 2 USD. ApexBot will continue to double the stake after every successful trade.'
            ),
            localize(
