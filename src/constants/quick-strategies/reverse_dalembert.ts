...
export const REVERSE_D_ALEMBERT = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Reverse D’Alembert strategy in ApexBot')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in ApexBot with Reverse D’Alembert strategy.')],
    },
    {
        type: 'text',
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. For trades that result in a profit, the stake for the next trade will be increased by 2 USD. ApexBot will continue to add 2 USD for every successful trade. See A1.'
            ),
            localize(
