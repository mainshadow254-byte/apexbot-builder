...
export const OSCARS_GRIND = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [`${localize('Exploring the')} Oscar's Grind ${localize('strategy in ApexBot')}`],
        expanded: true,
    ...
    },
    {
        type: 'text',
        content: [
            `${localize('These are the trade parameters used for')} Oscar's Grind ${localize('strategy in ApexBot.')}`,
        ],
    },
    {
        type: 'text',
